...
/// <summary>
/// Private owned-title library entry for a player.
/// </summary>
internal sealed class PlayerOwnedTitle
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the owned title identifier.
    /// </summary>
